// client/src/components/BestSelling.tsx - COMPLETE UPDATED FILE WITH PAGINATION
...
import { fetchBestSellingProducts } from "@/lib/utils/product.api";
...
export default function BestSelling() {
  ...
  useEffect(() => {
    const fetchProducts = async () => {
      try {
        ...
        const result = await fetchBestSellingProducts(1, 50);
        const bestSellingProducts = result.data || [];
        
        console.log("📦 Best selling products fetched:", bestSellingProducts.length);
        ...
        const allCategories: Category[] = [{ key: "all", label: "Popular" }];
        ...
        <div className="container mx-auto px-3 sm:px-4 md:px-6 lg:px-8">
          <div className="text-center mb-8 sm:mb-10 md:mb-12">
            <div className="inline-flex items-center px-3 py-1.5 sm:px-4 sm:py-2 bg-gradient-to-r from-slate-950 to-amber-500 rounded-full mb-3 sm:mb-4">
              ...
              <span className="text-white text-xs sm:text-sm md:text-md font-semibold">Best Selling</span>
            </div>
            <h2 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold text-slate-900 mb-3 sm:mb-4">
              Customer <span className="bg-gradient-to-r from-slate-950 to-amber-500 bg-clip-text text-transparent">Favorites</span>
            </h2>
  ...
  const totalSlides = maxIndex + 1; // Number of possible positions
      ...
      <section id="best-selling" className="py-8 sm:py-12 md:py-16 bg-white">
        <div className="container mx-auto px-3 sm:px-4 md:px-6 lg:px-8">
          <div className="text-center py-8 sm:py-12">
            <p className="text-slate-600">No best selling products available.</p>
          </div>
        </div>
      </section>
    );
      ...
      <div className="container mx-auto px-3 sm:px-4 md:px-6 lg:px-8">
            ...
            {isMobile ? (
              <div className="mb-4">
                <button onClick={() => setShowCategoryFilter(!showCategoryFilter)} className="w-full flex items-center justify-center gap-2 px-4 py-3 bg-gradient-to-r from-slate-950 to-amber-500 text-white rounded-lg font-medium shadow-lg text-sm sm:text-base">
                  ...
                  Filter: {activeFilter === "all" ? "Popular" : safeCategories.find(c => c.key === activeFilter)?.label || activeFilter}
                  ...
                  <button
                    ...
                    className={`px-3 py-1.5 sm:px-4 sm:py-2 md:px-5 md:py-2.5 rounded-full font-medium transition-all duration-300 text-xs sm:text-sm md:text-base ${
                      activeFilter === category.key
                        ? "bg-gradient-to-r from-slate-900 to-slate-700 text-white shadow-lg scale-105"
                        : "bg-white text-slate-800 border border-slate-200 hover:bg-slate-50 hover:text-amber-600"
                    }`}
                  >
                    {category.label}
                  </button>
        ...
        >
          ...
          {!isMobile && totalSlides > 1 && (
            <div className="absolute -top-12 right-0 z-10">
              <button onClick={toggleAutoplay} className="flex items-center gap-2 px-3 py-1.5 bg-white/90 backdrop-blur-sm border border-slate-200 rounded-lg text-xs font-medium text-slate-600 hover:bg-white hover:shadow-lg transition-all shadow-sm">
          ...
          <div className="flex flex-col sm:flex-row justify-center items-center gap-4 mt-6 sm:mt-8">
            {isMobile ? (
              <div className="flex items-center gap-3">
                <button onClick={handlePrevSlide} className="p-2 rounded-full hover:bg-slate-100 transition-colors">
                ...
                <button onClick={handleNextSlide} className="p-2 rounded-full hover:bg-slate-100 transition-colors">
        ...
        {isMobile && safeFilteredProducts.length > 0 && (
          <div className="flex justify-center mt-6">
            <Link href="/best-selling" className="inline-flex items-center px-6 py-3 bg-gradient-to-r from-slate-900 to-slate-700 hover:from-slate-950 hover:to-slate-800 text-white hover:text-amber-500 font-semibold rounded-full shadow-lg hover:shadow-xl text-base">
              View All Products
