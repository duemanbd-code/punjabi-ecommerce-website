      ...
      >
        ...
        >
          ...
          <div className="p-5 flex-1 flex flex-col bg-gradient-to-b from-white to-slate-50/50">
            ...
            <h3 className="font-bold text-amber-500 px-2 py-1 text-center rounded-2xl bg-slate-900 text-lg mb-3 line-clamp-1 group-hover:text-amber-600 transition-colors duration-300">
              {product.title}
            </h3>
