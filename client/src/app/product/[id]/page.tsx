...
// interface Review {
//   _id: string;
//   userId: string; // Track user who created the review
//   user: {
//     name: string;
//     avatar?: string;
//   };
...
//   // Initialize current user ID (simulate user login)
//   useEffect(() => {
...
//         // Parse sizes correctly - FIXED
//         const parseSizes = () => {
//           // Try variants first (new model)
...
//             }));
//           }
//           // Then try sizes field (old model)
...
//         // Process product data with ENHANCED synchronization with form
...
//           // Pricing (Synchronized with form fields)
...
//           // Calculate discount percentage (same logic as form)
//           discountPercentage:
...
//           // Product Flags (Synchronized with form flags)
...
//       } else {
//         // Start with empty array - no demo reviews
//         setReviews([]);
...
//   // Handle button actions with popup messages
...
//         // Include all pricing info for consistency
...
//         setActiveAction("buy"); // Reset to default
//       }, 1000);
//     } catch (error) {
...
//   // Calculate prices and discounts based on form data
//   // client/src/app/product/[id]/page.tsx - UPDATED price section

//   // Replace the price calculation section with:
...
//   // Get selected size object for stock display
...
//               <div className="bg-gradient-to-b from-slate-50 to-white rounded-2xl border border-slate-200 p-6 space-y-6">
...
//                     <div
//                       key={review._id}
//                       className="bg-gradient-to-b from-white to-slate-50 rounded-2xl border border-slate-200 p-6 relative"
//                     >
...
//                           <div className="w-12 h-12 rounded-full overflow-hidden bg-gradient-to-br from-slate-100 to-slate-200">
//                             <img
//                               src={
//                                 review.user.avatar ||
...
//               className="inline-flex items-center gap-2 px-6 py-3 bg-gradient-to-r from-amber-500 to-amber-600 text-white rounded-lg hover:shadow-lg hover:shadow-amber-500/25 transition-all"
//             >
//               <ArrowLeft size={18} />
//               Browse Products
//             </Link>
//             <Link
//               href="/"
//               className="inline-flex items-center gap-2 px-6 py-3 border border-slate-300 text-slate-700 rounded-lg hover:bg-gradient-to-r hover:from-slate-50 hover:to-white transition-all"
//             >
//               Go Home
//             </Link>
//           </div>
...
//       {/* Action Success Message Popup - Centered */}
//       {actionMessage && (
...
//                 </div>
//                 <div>
//                   <p className="text-2xl font-bold">{actionMessage.message}</p>
//                 </div>
//               </div>
//             </div>
//           </div>
...
//             <div
//               className="relative group aspect-square rounded-2xl overflow-hidden bg-gradient-to-br from-slate-100 to-slate-200 cursor-crosshair"
...
//               {/* Zoom Button - Removed wishlist, only share */}
//               <div className="absolute top-4 right-4 flex flex-col gap-2">
//                 {/* Only Share Button */}
//                 <button
//                   onClick={handleShare}
//                   className="p-3 bg-white/95 backdrop-blur-sm rounded-xl shadow-lg hover:shadow-xl hover:scale-105 transition-all duration-300 opacity-0 group-hover:opacity-100"
...
//               {/* Product Badges (Synchronized with form flags) */}
...
//                     <div className="relative px-4 py-2 bg-gradient-to-r from-rose-500 to-rose-600 text-white font-bold rounded-full shadow-lg">
...
//                 {product.isNew && (
//                   <div className="px-4 py-2 bg-gradient-to-r from-blue-500 to-blue-600 text-white font-bold rounded-full shadow-lg backdrop-blur-sm">
//                     <div className="flex items-center gap-2">
//                       <Sparkles size={14} />
//                       NEW ARRIVAL
//                     </div>
...
//                   <div className="px-4 py-2 bg-gradient-to-r from-amber-500 to-amber-600 text-white font-bold rounded-full shadow-lg backdrop-blur-sm">
//                     <div className="flex items-center gap-2">
//                       <TrendingUp size={14} />
//                       BESTSELLER
//                     </div>
...
//                 {product.featured && (
//                   <div className="px-4 py-2 bg-gradient-to-r from-purple-500 to-purple-600 text-white font-bold rounded-full shadow-lg backdrop-blur-sm">
//                     <div className="flex items-center gap-2">
//                       <Sparkles size={14} />
//                       FEATURED
//                     </div>
...
//                   <div className="px-3 py-2 bg-black/60 backdrop-blur-sm text-white text-sm font-medium rounded-full">
...
//                   <div className="px-4 py-2 bg-gradient-to-r from-red-700 to-red-500 text-white text-sm font-bold rounded-full shadow-lg backdrop-blur-sm animate-pulse">
//                     <div className="flex items-center gap-2">
//                       <Package size={14} />
//                       <span>Only {sizeStock} left!</span>
//                     </div>
//                   </div>
//                 </div>
//               )} */}
...
//               {isOutOfStock && (
//                 <div className="absolute bottom-4 left-4 z-10">
//                   <div className="px-4 py-2 bg-gradient-to-r from-slate-500 to-slate-600 text-white text-sm font-bold rounded-full shadow-lg backdrop-blur-sm">
//                     <div className="flex items-center gap-2">
//                       <Package size={14} />
...
//               {/* Action Buttons - Only Share (wishlist removed) */}
//               <div className="flex gap-2">
//                 <button
//                   onClick={handleShare}
//                   className="p-3 rounded-xl bg-gradient-to-b from-slate-50 to-white border border-slate-200 text-slate-700 hover:bg-gradient-to-r hover:from-blue-50 hover:to-blue-100 hover:text-blue-600 hover:border-blue-200 hover:scale-105 hover:shadow-lg transition-all duration-300"
//                   title="Share"
//                 >
//                   <Share2 size={20} />
//                 </button>
...
//             {product.rating > 0 && (
//               <div className="flex items-center gap-3">
//                 <div className="flex items-center gap-2 bg-gradient-to-r from-amber-50 to-amber-100 px-4 py-2 rounded-xl border border-amber-200">
//                   <div className="flex">
//                     {[...Array(5)].map((_, i) => (
//                       <Star
//                         key={i}
...
//             {/* Price Section - Synchronized with form */}
...
//                     </span>
//                     <div className="px-4 py-2 bg-gradient-to-r from-emerald-500 to-emerald-600 text-white font-bold rounded-full">
...
//               {/* Price Summary - Similar to form */}
//               {product.hasOffer && currentPrice < originalPrice && (
//                 <div className="mt-4 p-4 bg-gradient-to-r from-green-50 to-emerald-50 border border-green-200 rounded-xl">
//                   <div className="flex items-center justify-between">
//                     <div>
//                       <p className="text-sm text-slate-600">You Save</p>
...
//             {/* Size Selection - Synchronized with form sizes */}
...
//     rounded-2xl border border-slate-300 overflow-hidden shadow-sm"
//               >
//                 <button
...
//             {/* Action Buttons with Smart State Management */}
//             <div className="flex flex-col sm:flex-row gap-4">
//               {/* Add to Cart Button */}
//               <button
//                 onClick={handleAddToCart}
//                 onMouseEnter={() => setActiveAction("cart")}
//                 onMouseLeave={() => setActiveAction("buy")} // Reset to default on mouse leave
//                 disabled={product.stock <= 0 || addingToCart}
//                 className={`flex-1 py-5 px-6 rounded-xl font-bold
...
//                     <span
//                       key={index}
//                       className="px-3 py-2 bg-gradient-to-b from-slate-50 to-white text-slate-700 rounded-lg text-sm font-medium border border-slate-200"
//                     >
//                       {tag}
//                     </span>
//                   ))}
...
//               <div className="flex items-center gap-3 p-4 bg-gradient-to-b from-slate-50 to-white rounded-xl border border-slate-200">
...
//                 className={`flex items-center gap-2 px-6 py-4 font-medium text-sm uppercase tracking-wider transition-all duration-300 ${
//                   activeTab === tab.id
...
//           <div className="p-8 bg-gradient-to-b from-white to-slate-50 rounded-2xl border border-slate-200">
//             {renderTabContent()}
//           </div>
//         </div>
//       </div>
